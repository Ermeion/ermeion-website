...
function WhyErmeionSection() {
  const checklistItems = [
    'Χρόνιοι πόνοι στη μέση, οσφυαλγία και δισκοκήλες',
    'Τραυματισμοί στο γόνατο, το ισχίο και τον αστράγαλο',
    'Αθλητικοί τραυματισμοί (sports rehab) και δυσκαμψία',
    'Πόνος στον αυχένα, στους ώμους και προβλήματα στάσης σώματος',
    'Τενοντοπάθειες, τραυματισμοί στροφικού πετάλου και ρήξη υπερακανθίου',
    'Πόνος στον καρπό, τον αγκώνα, το χέρι και κακώσεις από επαναλαμβανόμενες κινήσεις',
  ];
