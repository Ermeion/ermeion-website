        ...
        <div className="w-full lg:w-[55%] flex flex-col">
          ...
          <div className="flex flex-col gap-4 mb-8">
            <p className="text-sm sm:text-sm leading-relaxed" style={{ color: '#3d3d3d' }}>
              Αυτό εξαρτάται από τη σωστή αξιολόγηση, θεραπεία και πλάνo.
            <p className="text-sm sm:text-sm leading-relaxed" style={{ color: '#3d3d3d' }}>
            ...
            <p className="text-sm sm:text-sm leading-relaxed" style={{ color: '#3d3d3d' }}>
              Η φυσικοθεραπεία μπορεί να βοηθήσει με πόνο, δυσκαμψία, τραυματισμούς, μετεγχειρητικής αποκατάστασης και των προβλημάτων κίνησης σε ολόκληρο το σώμα, όχι μόνο στον πόνο της μέσης ή του γόνατος.
            </p>
          </div>
