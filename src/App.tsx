...
function WhyErmeionSection() {
  const checklistItems = [
    'Χρόνιο πόνους στη μέση, οσφυαλγία και δισκοκήλες',
    'Τραυματισμό στο γόνατο, το ισχίο και τον αστράγαλο',
    ...
    'Πόνο στον καρπό, τον αγκώνα, το χέρι και κακώσεις από επαναλαμβανόμενες κινήσεις',
  ];
